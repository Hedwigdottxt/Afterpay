...
<body onload="getSeconds();">
  <script>
    ...
    var countertime = new Date(nowDate.getFullYear(),nowDate.getMonth(),nowDate.getDate(),16,45,0); //20 out of 24 hours = 8pm
    ...
    if (secs>0) {
      ...
      docs.setAttribute("src", "confetti.gif");
      var x = document.getElementById("countholder");
