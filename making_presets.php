...
<div class="wrapper">
    <div id ="1" class="box a" ondrop="drop(event)" ondragover="allowDrop(event)">
        ...
        <?php } ?>
        <?php if ($page->index1 == "countdown") { ?>
            <?php require "Countdown_Friday_widget.php"?>
        <?php } ?>
        <?php if ($page->index1 == "verjaardag") { ?>
            <?php require "verjaardagen_widget.php"?>
        <?php } ?>
        <?php if ($page->index1 == "server") { ?>
            <?php require "server_widget.php"?>
        <?php } ?></div>
    <div id="2" class="box b" ondrop="drop(event)" ondragover="allowDrop(event)" >
        ...
        <?php if ($page->index2 == "order") { ?>
            <?php require "orderaantallen_widget.php"?>
        <?php } ?>
        <?php if ($page->index2 == "countdown") { ?>
            <?php require "Countdown_Friday_widget.php"?>
        <?php } ?>
        <?php if ($page->index2 == "verjaardag") { ?>
            <?php require "verjaardagen_widget.php"?>
        <?php } ?>
        <?php if ($page->index2 == "server") { ?>
            <?php require "server_widget.php"?>
        <?php } ?></div>
    <div id="3" class="box c" ondrop="drop(event)" ondragover="allowDrop(event)" >
        ...
        <?php if ($page->index3 == "order") { ?>
            <?php require "orderaantallen_widget.php"?>
        <?php } ?>
        <?php if ($page->index3 == "countdown") { ?>
            <?php require "Countdown_Friday_widget.php"?>
        <?php } ?>
        <?php if ($page->index3 == "verjaardag") { ?>
            <?php require "verjaardagen_widget.php"?>
        <?php } ?>
        <?php if ($page->index3 == "server") { ?>
            <?php require "server_widget.php"?>
        <?php } ?></div>
    <div id="4" class="box d" ondrop="drop(event)" ondragover="allowDrop(event)" >
        ...
        <?php if ($page->index4 == "order") { ?>
            <?php require "orderaantallen_widget.php"?>
        <?php } ?>
        <?php if ($page->index4 == "countdown") { ?>
            <?php require "Countdown_Friday_widget.php"?>
        <?php } ?>
        <?php if ($page->index4 == "verjaardag") { ?>
            <?php require "verjaardagen_widget.php"?>
        <?php } ?>
        <?php if ($page->index4 == "server") { ?>
            <?php require "server_widget.php"?>
        <?php } ?></div>
</div>
</body>
